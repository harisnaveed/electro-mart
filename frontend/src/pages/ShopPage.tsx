              ...
              >
                <div className="p-4">
                  ...
                  <div className="mt-3 flex flex-wrap gap-2 text-xs text-zinc-600">
                    {p.manufacturer ? (
                      <span className="rounded-full bg-zinc-100 px-2 py-1 dark:bg-gray-800 dark:text-gray-400">
                        {p.manufacturer}
                      </span>
                    ) : null}
                    {p.type ? (
                    ...
                    {p.sku ? (
                      <span className="rounded-full bg-zinc-100 px-2 py-1 font-mono dark:bg-gray-800 dark:text-gray-400">
                        {p.sku}
                      </span>
                    ) : null}
                  </div>
                  ...
                  <button
                    ...
                    className="
                      ...
                      dark:shadow-[0_8px_20px_rgba(0,0,0,0.15)]
                    "
                  >
