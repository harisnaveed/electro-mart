            ...
            {paginated.map((p) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <button
                    type="button"
                    className="mt-4 w-full rounded-xl bg-zinc-900 px-4 py-2.5 text-sm font-small text-white transition hover:bg-zinc-800 focus:outline-none cursor-pointer focus:ring-2 focus:ring-zinc-300"
                  >
                    Add to cart
                  </button>
                </div>
