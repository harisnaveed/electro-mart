        ...
        {error ? (
          <div className="rounded-2xl border border-red-200 bg-red-50 p-5 text-sm text-red-800">
            ...
            <p className="mt-3 text-red-700/90">
              ...
              <span className="font-mono"> .env</span> file to your API endpoint.
            </p>
          </div>
        ) : loading ? (
      ...
      <footer className="border-t border-zinc-200 bg-white">
        <div className="mx-auto max-w-6xl px-4 py-6 text-sm text-zinc-600">
          <p className="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
            <span>
              Edit <span className="font-mono">VITE_PRODUCTS_API_URL</span> to use your
              API.
            </span>
            <span className="font-mono text-[13px]">React 19 • Tailwind v4</span>
          </p>
        </div>
      </footer>
    </div>
